...
\noindent\textbf{What is the lead-time gain of {\sf {\bf SourceMine}}?} Finally, we analyze the average lead-time of \locationmodel and \fullmodel to examine if the proposed models can detect outbreaks in a timely manner. \Cref{fig:lead_timeline} shows the lead-time timeline of the two models from January 2013 to March 2014. We observe that both models have a significant lead-time advantage when compared against  the mention of the outbreak in news sources.
