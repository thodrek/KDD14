...
\label{sec:exp}
We present an empirical evaluation of \model and the overall proposed framework. The main questions we seek to address are: (1) how effective is \model at discovering disease topics and their corresponding spatio-temporal patterns, (2) how accurately can the proposed model predict future disease outbreak . We empirically study these questions using a real-world dataset.
\subsection{Experimental Setup}
\label{sec:exp_setup}
\subsection{Verifying \model}
\label{sec:exp_topic}
\subsection{Predicting Rare Disease Outbreaks} 
