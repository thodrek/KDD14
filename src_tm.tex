...
\begin{figure*}[ht]
\begin{center}
        \subfigure{\includegraphics[trim = 40mm 35mm 80mm 25mm, clip, scale=0.4]{fig/lda_model.eps} \label{fig:lda_model}}
        \subfigure{\includegraphics[trim = 40mm 35mm 70mm 25mm, clip, scale=0.4]{fig/at_model.eps} \label{fig:at_model}}
        \subfigure{\includegraphics[trim = 30mm 35mm 70mm 25mm, clip, scale=0.4]{fig/stm_model.eps} \label{fig:stm_model}}
\end{center}
...
We evaluate the performance of the various disease outbreak detection algorithms focusing on Hantavirus incidences at four countries - Argentina, Chile, Uruguay and Brazil - for which cases of hantavirus outbreaks were reported. We apply BSR,  \fullmodel and \locationmodel. We evaluate the performance of \fullmodel and \locationmodel with $k \in \{5,10,20,50\}$. We use the three hantavirus topics described above to construct the necessary feature vectors for \fullmodel and \locationmodel.  \Cref{tab:results} shows the precision, recall and F1 score  of the three approaches from January 2013 to March 2014 averaged over the four countries. For \locationmodel and \fullmodel we report the results corresponding to the configuration $k$ that obtained the best performance. 
...
\begin{table}[h]
  ...
  \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
    ...
    \multicolumn{3}{c|}{{\bf \locationmodel}} &
    \multicolumn{3}{c|}{{\bf \fullmodel}} \\
    \cline{2-10} {\em Month}   & {\em Prec.} & {\em Rec.} & {\em F1} & {\em Prec.} & {\em Rec.} & {\em F1} & {\em Prec.} & {\em Rec.} & {\em F1} \\
    \hline 
    {\bf Jan-2013} & 2.84 & 5.00 & 0.67 & 2.88 & 5.80 & 0.30 & 2.88 & 5.80 & 0.30\\ 
    \hline
...
\begin{table}[h]
  %\centering
  \caption{Performance evaluation for BSR, \locationmodel and \fullmodel on predicting Hantavirus outbreaks in Chile, Argentina, Brazil and Uruguay from January 2013 to March 2014.}
