...
The dataset we have used for training our models is the HealthMap [?] (www.healthmap.org) 
...
The $a_{date}$ is calculated as $a_{date} = 1-min(|predicted date in the warning - actual event date|, 7)/7$.
