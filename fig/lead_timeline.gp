...
plot "lead_timeline.dat" using 1:2 with linespoints pt 7 ps 3 lw 4 lt 1 lc rgb "green" title "KeyWord", \
     "lead_timeline.dat" using 1:3 with linespoints pt 3 ps 3 lw 4 lt 1 lc rgb "black"  title "LocSeer", \
     "lead_timeline.dat" using 1:4 with linespoints pt 14 ps 3 lw 4 lt 1 lc rgb "blue" title "SourceSeer"
