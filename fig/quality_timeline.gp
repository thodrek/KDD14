...
plot "quality_timeline.dat" using 1:2 with linespoints pt 6 ps 3 lw 4 lt 1 lc 1 title "BSR", \
     "quality_timeline.dat" using 1:3 with linespoints pt 3 ps 3 lw 4 lt 1 lc 0 title "L-STAT", \
     "quality_timeline.dat" using 1:4 with linespoints pt 14 ps 3 lw 4 lt 1 lc 3 title "S-STAT"
