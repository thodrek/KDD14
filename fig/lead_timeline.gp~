...
plot "lead_timeline.dat" using 1:2 with linespoints pt 6 ps 3 lw 4 lt 1 lc 1 title "L-STAT", \
     "lead_timeline.dat" using 1:3 with linespoints pt 3 ps 3 lw 4 lt 1 lc 0 title "S-STAT"
