...
set output "hanta_timelines_Brazil.eps"
set size ratio 0.4
...
plot "hanta_timelines.dat" using 1:4 with linespoints pt 6 ps 3 lw 4 lt 1 lc 1 title "Brazil", \
     "hanta_timelines.dat" using 1:5 with linespoints pt 3 ps 3 lw 4 lt 1 lc 0 title "Uruguay"